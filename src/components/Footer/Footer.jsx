...
const Footer = () => {
  return (
    <footer className="py-6 mt-20 text-gray-500 flex flex-col justify-center items-center border-t-2">
      <div>
        ...
        <div className="social-link flex justify-center mt-5">
          ...
          <a
            ...
            href="/"
            title="Twitter"
            className="flex items-center mx-3 justify-center w-10 h-10 rounded-full dark:bg-violet-400 dark:text-gray-900"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 50 50"
